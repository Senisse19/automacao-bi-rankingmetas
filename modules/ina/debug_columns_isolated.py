...
# Set dummy env vars to bypass validation in Supabase/Sharepoint clients
...
logger = get_logger("debug_isolated")
...
def run():
    ...
    # Check distinct values for 'nome_fantasia' vs 'Razão Social' if exists
