...
def robust_sync():
    ...
    for m in all_modelos:
        ...
        if dt and dt >= "2024-01-01":
            ...
            if m.get("unidade"):
                required_units.add(str(m.get("unidade")))
            if m.get("consultor_venda"):
                required_participants.add(str(m.get("consultor_venda")))
